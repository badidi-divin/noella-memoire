<?php
    session_start();
        ...
        require_once("../model/selectionCommunique2.php");
   ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <h1 class="mb-4">COMMUNIQUE CONCERNANT Mr.(Mdm) <a href="logout.php" title="voulez-vous déconnecter?"> <?= $_SESSION['nom_de_famille']  ?></a></h1> 
   ...
   <div class="container">
      <div class="row justify-content-center pb-4">
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">COMMUNICATION INDIVIDUELLE</h2>
        </div>
    </div>
    <div class="row">
    <?php
    ...
    <div class="col-md-4 ftco-animate">
      <div class="project-wrap">
           <a href="#" class="img" style="background-image: url('../includes/images/21.jpg')">
              <span class="price"><?= $blog->nom; ?></span>
          </a>
          <div class="text p-4">
              <p><?= substr($blog->description, 0,50);?>...</p>
              <p><?= $blog->dates;?></p>
              <a href="suite2.php?id=<?= $blog->id; ?>" class="btn btn-primary">lire la suite</a>    
          </div>
      </div>
  </div>
   <?php
