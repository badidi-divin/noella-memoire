<?php
	...
	require_once '../../model/admin/insert-com.php';
?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="panel-body">
			...
			<form method="post" action="" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="evenement" required="required" class="form-control">
				</div>
				<div class="form-group">
					<label class="control-label">
						Description:
					</label>
					<textarea type="text" name="description" required="required" class="form-control">
